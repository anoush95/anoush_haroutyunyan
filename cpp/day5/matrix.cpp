...
int main()
{
	...
	<< "Upper left triangle: " << upper_left_triangle << endl << "Lower right triangle: " << lower_right_triangle << endl 
	<< "Upper triangle: " << upper_triangle << endl << "Right triangle: " << right_triangle << endl << "Lower triangle: " 
